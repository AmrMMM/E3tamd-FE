...
import 'package:e3tmed/logic/interfaces/ILogic.dart';
import 'package:e3tmed/logic/models/CarItem.dart';
import 'package:e3tmed/logic/models/CarModel.dart';
    ...
    return itemImgList
        .map((img) => Image.network(
              ...
              loadingBuilder: (context, img, progress) {
                ...
                return Center(child: MainLoadinIndicatorWidget());
              },
            ))
        .toList();
  }
