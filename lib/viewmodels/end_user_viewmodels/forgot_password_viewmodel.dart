...
class ForgotPasswordViewModel extends BaseViewModelWithLogic<IAuth> {
  ForgotPasswordViewModel(BuildContext context) : super(context);
  ...
  verifyUsername(String userName) async {
    _loading.add(true);
    _isChangingPassword.add(await logic.forgetPassword(userName));
